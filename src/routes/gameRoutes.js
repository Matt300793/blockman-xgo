...
// Simple authentication middleware migrated to async/await MySQL
const authenticate = async (req, res, next) => {
    ...
    try {
        // mysql2 pool returns an array where the first element contains the rows
        ...
        console.error('Middleware authentication database error:', err.message);
