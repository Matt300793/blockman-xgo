...
void main(void)
{
	...
	color = (litParam[1] * max(0.0, max(dot(normalize(vNormal), litParam[3].xyz), dot(normalize(vNormal), litParam[0].xyz))) + litParam[2] * ambientColor) + naturalColor;
	color.a = naturalColor.a;
}